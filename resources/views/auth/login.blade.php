    ...
    <main class="flex-1 flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl shadow-lg p-8">
                ...
                <p class="text-gray-500 text-sm mb-6">Войдите, чтобы загружать активации и видеть их статус.</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    @csrf
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Позывной или email</label>
                ...
                <p class="text-sm text-gray-600 mt-6 text-center">
                    ...
                    <a href="{{ route('register') }}"
                        class="text-[--color-primary-600] font-semibold hover:underline">Зарегистрироваться</a>
                </p>
            </div>
        </div>
    </main>
